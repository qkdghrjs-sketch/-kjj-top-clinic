        ...
        <div className="max-w-6xl mx-auto px-4">
          ...
          <div className="grid sm:grid-cols-2 gap-6">
            {[
              {
                name: "속쓰림·역류",
                desc: "식후 가슴이 타는 듯한 느낌, 신물이 올라온다면\n역류성식도염을 의심해보세요.\n방치하면 바렛식도, 식도암으로 진행될 수 있어\n조기 검사가 매우 중요합니다.",
              },
              {
                name: "상복부 통증",
                desc: "식전이나 식후에 상복부가 쓰리거나\n압박감이 느껴진다면 위염·위궤양을 의심하세요.\n헬리코박터균 감염이 주요 원인이며\n내시경으로 직접 확인이 가능합니다.",
              },
              {
                name: "소화불량",
                desc: "더부룩함, 조기 포만감, 소화가 잘 안 되는 증상이\n4주 이상 지속된다면 검사가 필요합니다.\n기능성 소화불량과 기질적 원인을\n내시경으로 정확히 감별합니다.",
              },
              {
                name: "혈변·흑변",
                desc: "검은색 변이나 혈변이 나온다면\n즉시 내시경 검사가 필요합니다.\n위장관 출혈의 위치와 원인을\n내시경으로 정확히 확인합니다.",
              },
            ].map((item, i) => (
        ...
        <div className="max-w-3xl mx-auto px-4">
          ...
          <FAQ
            items={[
              ...
              { q: "위내시경과 수면내시경 중 어떤 게 좋나요?", a: "검사에 대한 불안감이 있으시다면 수면내시경을 권장합니다.\n수면 중 검사하므로 통증과 불편감이 없습니다." },
              { q: "역류성식도염은 완치가 가능한가요?", a: "생활습관 개선(취침 전 2시간 금식, 과식 금지)과 약물치료로\n증상 조절이 가능합니다." },
              { q: "소화불량이 오래되면 꼭 내시경을 받아야 하나요?", a: "4주 이상 지속되거나 체중감소, 연하곤란이 동반된다면\n내시경 검사를 강력히 권장합니다." },
            ]}
          />
        </div>
      </section>
