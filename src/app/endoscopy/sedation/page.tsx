...
const advantages = [
  { name: "통증 없음", desc: "수면 유도제 효과로 검사 중 아무런 통증과 불편감을 느끼지 않습니다.\n내시경 공포증이 있는 분도 편안하게 받을 수 있습니다." },
  { name: "더 정확한 검사", desc: "환자의 움직임이 없어 의사가 더 꼼꼼하게 관찰할 수 있습니다.\n작은 병변도 놓치지 않는 정밀한 검사가 가능합니다." },
  { name: "빠른 검사", desc: "협조가 잘 되어 일반 내시경보다 검사 시간이 단축됩니다.\n위내시경 5~10분, 대장내시경 15~30분이면 완료됩니다." },
  { name: "심리적 안정", desc: "내시경에 대한 두려움으로 미루고 계셨다면 수면내시경을 선택하세요.\n검사 후 \"생각보다 편했다\"고 하시는 분이 대부분입니다." },
];
...
const faqItems = [
  { q: "수면내시경 후 바로 운전할 수 없나요?", a: "당일 운전은 절대 불가합니다. 수면 유도제가 완전히 깨어난 것처럼 느껴지더라도 판단력에 영향을 줄 수 있어 보호자 동반이 필수입니다." },
  { q: "수면에서 깨어나는 데 얼마나 걸리나요?", a: "보통 30~60분 후 완전히 각성됩니다. 회복실에서 충분히 쉬신 후 귀가하실 수 있습니다." },
  { q: "수면내시경을 못 받는 경우가 있나요?", a: "임산부, 수면 유도제 알레르기가 있는 분, 특정 약물 복용자, 뇌·심장·폐질환 및 급성 호흡기질환 감염자는 사전 상담이 필요합니다." },
  { q: "검사 중에 깨어날 수도 있나요?", a: "드물게 각성되는 경우가 있으나 추가 투여로 조절 가능합니다. 검사 내용은 기억하지 못하는 것이 정상입니다." },
  { q: "수면내시경 비용은 얼마인가요?", a: "보험 적용 여부에 따라 다릅니다. 자세한 비용은 내원 시 또는 전화 상담으로 안내해 드립니다." },
];
  ...
  return (
    <>
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <p className="text-sky-300 text-sm sm:text-base font-medium">최신 내시경 장비</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">충분한 회복</p>
              <p className="text-sky-300 text-sm sm:text-base font-medium">편안한 회복실 완비</p>
            </div>
            <div className="text-center">
              <p className="text-2xl sm:text-3xl md:text-4xl font-bold text-white mb-1 sm:mb-2">안전 관리</p>
              <p className="text-sky-300 text-sm sm:text-base font-medium">바이탈 사인 실시간 감시</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <ScrollReveal delay={150}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-navy-900 mb-5">통증 없이 편안하게, 더 정확하게</h2>
              <p className="text-gray-600 leading-relaxed mb-4 whitespace-pre-line">{"수면내시경은 안전한 수면 유도제를 사용하여 검사 중\n의식이 없는 상태에서 진행하는 내시경입니다."}</p>
              <p className="text-gray-600 leading-relaxed mb-4 whitespace-pre-line">{"검사 중 아무런 불편감을 느끼지 못하며 검사 내용을 기억하지\n못하는 것이 정상입니다."}</p>
              <p className="text-gray-600 leading-relaxed whitespace-pre-line">{"일반 내시경보다 환자의 협조가 잘 되어 더 꼼꼼하고\n정확한 검사가 가능합니다."}</p>
            </ScrollReveal>
          </div>
        </div>
      </section>
      ...
      <section className="py-12 sm:py-16 md:py-20 bg-white">
        <div className="max-w-4xl mx-auto px-4">
          <ScrollReveal>
            <div className="bg-red-50 border-2 border-red-400 rounded-2xl p-4 sm:p-8">
