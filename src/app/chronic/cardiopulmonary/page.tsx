        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold text-white mb-2">심전도 검사</p>
              <p className="text-sky-300 text-sm font-medium">당일 판독</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold text-white mb-2">폐기능 검사</p>
              <p className="text-sky-300 text-sm font-medium">당일 판독</p>
            </div>
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold text-white mb-2">흉부 X-ray</p>
              <p className="text-sky-300 text-sm font-medium">당일 판독</p>
            </div>
          </div>
        </div>
