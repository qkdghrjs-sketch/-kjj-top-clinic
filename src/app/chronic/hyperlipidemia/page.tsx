        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10">
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold text-white mb-2">100 미만</p>
              <p className="text-sky-300 text-sm font-medium">LDL 콜레스테롤 목표</p>
            </div>
            <CountUp end={50} suffix="%" label="심근경색 위험 감소" />
            <div className="text-center">
              <p className="text-4xl md:text-5xl font-bold text-white mb-2">6개월</p>
              <p className="text-sky-300 text-sm font-medium">혈액검사 주기</p>
            </div>
          </div>
        </div>
      </section>
