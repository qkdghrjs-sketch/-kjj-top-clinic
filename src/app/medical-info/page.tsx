    ...
    groups: [
      {
        title: "종합검진",
        items: [
          { name: "탑50 건강검진", price: "690,000 (할인가 550,000)" },
          { name: "탑40 건강검진", price: "560,000 (할인가 450,000)" },
          { name: "탑30 건강검진", price: "360,000 (할인가 300,000)" },
          { name: "탑20 건강검진", price: "250,000 (할인가 200,000)" },
          { name: "혈액종합검사", price: "120,000 (할인가 100,000)" },
        ],
      },
      {
        title: "개인검진",
        items: [
          ...
          { name: "보건증 (Chest + widal test)", price: "30,000" },
          { name: "입소용검진 (전염성질환 포함)", price: "30,000" },
          { name: "채용 - 공무원", price: "40,000~45,000" },
          { name: "채용 - 일반", price: "35,000~40,000" },
        ],
      },
      {
        title: "혈액검사",
        items: [
          ...
          { name: "에이즈/매독 검사", price: "18,000" },
          { name: "HIV 항원/항체 (정밀)", price: "15,000" },
          { name: "NK세포활성도", price: "100,000" },
          { name: "마스토 (유방암)", price: "100,000" },
          { name: "매독반응 (RPR)", price: "5,000" },
          { name: "방사선종사자검사", price: "15,000" },
          { name: "비타민 D 검사", price: "10,000" },
          { name: "수두/풍진/홍역 항체검사 (검사당)", price: "20,000" },
          { name: "알츠하이머 위험도", price: "100,000" },
          { name: "혈중아미노산검사", price: "108,330" },
          {
            name: "암유전자검사 (6종) 공통 - 치매·뇌졸중·심근경색·파킨슨병·2형당뇨·고혈압",
            price: "150,000",
          },
          {
            name: "암유전자검사 (7종) 남성 - 갑상선암·폐암·위암·간암·대장암·췌장암·전립선암",
            price: "150,000",
          },
          {
            name: "암유전자검사 (9종) 여성 - 갑상선암·폐암·위암·간암·대장암·췌장암·유방암·난소암·자궁경부암",
            price: "150,000",
          },
          {
            name: "암유전자검사 (13종) 남성종합 - 6종 공통 + 7종 남성",
            price: "230,000",
          },
          {
            name: "암유전자검사 (13종) 남성종합 - 6종 공통 + 9종 여성",
            price: "230,000",
          },
          { name: "텔로미어 혈액검사 (DNA 노화검사)", price: "300,000" },
          { name: "여성난소검사 (AMH수치)", price: "60,000" },
          { name: "음식물과민증검사", price: "300,000" },
          { name: "일반질환 유전자 검사 (27종)", price: "280,000" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "마약 4종 (필로폰/대마/모르핀·아편/코카인)", price: "40,000" },
          { name: "마약 6종 (마약4종 + 암페타민/엑스터시)", price: "60,000" },
          { name: "성매개감염 STD 12종 (소변, HIV 불포함)", price: "50,000" },
          { name: "유기산검사", price: "300,000" },
        ],
      },
      {
        title: "분변검사",
      ...
      },
      {
        ...
        items: [
          ...
          { name: "지방간·지방섬유화 검사", price: "50,000" },
          { name: "전문 상복부 (섬유화·지방간 측정 포함)", price: "80,000" },
      ...
      },
      {
        ...
        items: [
          ...
          { name: "잠복결핵 IFN-γ (혈액)", price: "55,000" },
          { name: "성매개감염 STD 12종 (소변, HIV 불포함)", price: "50,000" },
    ...
    groups: [
      {
        ...
        items: [
          ...
          { name: "페라비르주 (60ml)", price: "100,000" },
          { name: "라보솔주", price: "50,000" },
          { name: "닥터라민주", price: "50,000" },
          { name: "뉴트리헥스", price: "50,000" },
          { name: "아르믹스주", price: "30,000" },
          { name: "코로나영양수액", price: "95,000" },
          { name: "독감수액", price: "95,000" },
          { name: "5% 포도당키트 110ml", price: "15,000" },
          { name: "5% 포도당키트 250ml", price: "40,000" },
          { name: "판비콤프주", price: "10,000" },
          { name: "멀티미네륨5주", price: "50,000" },
          { name: "아모부로펜프리믹스주", price: "60,000" },
          { name: "파라몰주", price: "50,000" },
          { name: "아세트펜프리믹스주", price: "50,000" },
          { name: "하이코민주", price: "20,000" },
          { name: "지씨비타오주", price: "10,000" },
          { name: "휴온스피리독신염산주", price: "10,000" },
    ...
    groups: [
      {
        ...
        items: [
          ...
          { name: "일반진단서", price: "20,000" },
          { name: "진단서 (근로능력평가용)", price: "10,000" },
          { name: "영문진단서", price: "20,000" },
          { name: "진료확인서/통원확인서", price: "3,000" },
          { name: "제증명서 사본", price: "1,000" },
        ],
      },
    ],
  },
