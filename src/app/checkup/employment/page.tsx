        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-bold text-white mb-2">20~25분</p>
              <p className="text-sky-300 text-sm font-medium">신속 검진</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-bold text-white mb-2">당일</p>
              <p className="text-sky-300 text-sm font-medium">결과 확인</p>
            </div>
            <div className="text-center">
              <p className="text-3xl md:text-4xl font-bold text-white mb-2">전문의</p>
              <p className="text-sky-300 text-sm font-medium">직접 판독</p>
            </div>
          </div>
        </div>
      </section>
