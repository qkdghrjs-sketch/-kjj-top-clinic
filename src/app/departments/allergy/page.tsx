        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">혈액 알레르기 검사</p>
              <p className="text-sky-300 text-xs sm:text-sm font-medium">100여 가지 항원 분석</p>
            </div>
            <div className="text-center">
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">원인 항원 분석</p>
              <p className="text-sky-300 text-xs sm:text-sm font-medium">정밀 원인 파악</p>
            </div>
            <div className="text-center">
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">면역치료 연계</p>
              <p className="text-sky-300 text-xs sm:text-sm font-medium">근본적 치료 가능</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <ScrollReveal delay={150}>
              <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-navy-900 mb-5">알레르기 전문 진료</h2>
