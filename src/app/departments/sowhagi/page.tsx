        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <ScrollReveal delay={150}>
              ...
              <p className="text-gray-600 leading-relaxed whitespace-pre-line">{"지속되는 변비, 설사, 소화불량, 체중감소, 혈변, 황달 등의 증상이 있으시다면\n혼자 고민하지 마시고 김정재탑내과를 방문해주세요.\n소화기내시경 세부전문의가 정확한 진단과 맞춤 치료를 도와드립니다."}</p>
            </ScrollReveal>
          </div>
        </div>
      </section>
