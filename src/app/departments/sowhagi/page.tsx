...
const diseases = [
  { name: "역류성위식도염", desc: "위산이 식도로 역류하여 점막을 손상시키는 질환입니다. 방치 시 바렛식도, 식도암으로 진행될 수 있어 조기 치료가 중요합니다." },
  { name: "위/십이지장궤양", desc: "상복부 통증, 더부룩함, 구역감이 지속된다면 위염을 의심하세요. 헬리코박터균이 주요 원인이며 위내시경으로 정확히 진단합니다." },
  { name: "과민성장증후군", desc: "반복되는 복통, 설사와 변비가 번갈아 나타나는 질환입니다. 스트레스와 식이 요인이 주요 원인으로 생활습관 개선이 중요합니다." },
  { name: "대장용종", desc: "대장암의 90%는 용종에서 시작됩니다. 초기 증상이 없어 정기 대장내시경이 유일한 예방법이며, 발견 즉시 당일 절제가 가능합니다." },
];
