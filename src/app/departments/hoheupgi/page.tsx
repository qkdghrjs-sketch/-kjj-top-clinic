...
const respiratoryDiseases = [
  { name: "천식", desc: "기도의 만성 염증으로 호흡곤란, 쌕쌕거림이 반복됩니다.\n알레르기 항원, 찬 공기 등이 악화 요인이며\n흡입기 치료로 효과적으로 조절할 수 있습니다." },
  { name: "COPD", desc: "흡연이 주원인인 만성 폐쇄성 폐질환으로\n폐 기능이 점진적으로 감소합니다.\n금연과 정기 폐기능 검사로 진행을 늦출 수 있습니다." },
  { name: "폐렴", desc: "세균, 바이러스 등에 의한 폐 감염 질환으로\n고열, 기침, 흉통이 주요 증상입니다.\n노인과 면역저하자는 특히 주의가 필요합니다." },
  { name: "기관지염", desc: "기관지 염증으로 기침, 가래, 미열이 지속됩니다.\n만성 기관지염은 COPD로 진행될 수 있어\n적절한 치료와 금연이 중요합니다." },
];

const allergyDiseases = [
  { name: "알레르기 비염", desc: "재채기, 맑은 콧물, 코막힘이 반복된다면\n알레르기 비염일 수 있습니다.\n항원 검사로 원인을 찾아 치료합니다." },
  { name: "상세불명의 두드러기", desc: "피부에 갑자기 붉은 팽진과\n심한 가려움이 동반됩니다.\n원인 파악과 항히스타민제로 조절합니다." },
  { name: "식품 알레르기", desc: "특정 음식 섭취 후 두드러기 등이 나타납니다.\n혈액검사로 원인 식품을 파악하며,\n심한 경우 응급 상황이 될 수 있습니다." },
];
...
export default function HoheupgiPage() {
  return (
    <>
      <PageHeader
        title="호흡기·알레르기센터"
        subtitle="기관지, 폐 건강과 알레르기 질환의 정밀 진단 및 맞춤 치료를 제공합니다."
      />
        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 sm:gap-8">
            <div className="text-center">
              ...
              <p className="text-sky-300 text-sm sm:text-base font-medium">정밀 호흡 능력 측정</p>
            </div>
            <div className="text-center">
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">흉부 X-ray 당일 판독</p>
              <p className="text-sky-300 text-sm sm:text-base font-medium">빠른 결과 확인</p>
            </div>
            <div className="text-center">
              <p className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-2">알레르기 검사 176종</p>
              <p className="text-sky-300 text-sm sm:text-base font-medium">정밀 원인 항원 분석</p>
            </div>
          </div>
        </div>
      </section>
