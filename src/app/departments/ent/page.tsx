        ...
        <div className="relative z-10 max-w-5xl mx-auto px-4">
          <div className="grid grid-cols-3 gap-8">
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-bold text-white mb-2">내시경 비인두 검사</p>
              <p className="text-sky-300 text-sm font-medium">정밀 비인두 관찰</p>
            </div>
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-bold text-white mb-2">청력 검사</p>
              <p className="text-sky-300 text-sm font-medium">정밀 청력 평가</p>
            </div>
            <div className="text-center">
              <p className="text-2xl md:text-3xl font-bold text-white mb-2">현기증 정밀 평가</p>
              <p className="text-sky-300 text-sm font-medium">원인 감별 진단</p>
            </div>
          </div>
        </div>
      </section>
        ...
        <div className="max-w-6xl mx-auto px-4">
          <div className="grid md:grid-cols-2 gap-10 items-center">
            ...
            <ScrollReveal delay={150}>
              <h2 className="text-2xl md:text-3xl font-bold text-navy-900 mb-5">이비인후과 전문 진료</h2>
