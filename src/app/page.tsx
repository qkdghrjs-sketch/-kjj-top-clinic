              ...
              <ScrollReveal key={card.title} delay={i * 100}>
                <div className="group relative rounded-2xl overflow-hidden h-44 sm:h-72 cursor-default shadow-md hover:shadow-xl transition-shadow duration-300">
                  ...
                  <div className="relative z-10 h-full flex flex-col justify-between p-3 sm:p-5">
                    <div>
                      <span className="inline-block bg-sky-500 text-white text-xs sm:text-base font-bold px-2 py-1 sm:px-3 sm:py-1.5 rounded-full">
                        {card.title}
                      </span>
                    </div>
                    <div>
                      <p className="text-white text-sm sm:text-lg leading-snug sm:leading-relaxed font-medium mb-2 sm:mb-3 whitespace-pre-line">
                        {card.desc}
                      </p>
                      <Link
                        href={card.href}
                        className="inline-flex items-center gap-1 text-xs sm:text-sm font-semibold text-white border border-white/50 bg-white/10 backdrop-blur-sm px-3 py-1.5 sm:px-4 sm:py-2 rounded-lg hover:bg-white hover:text-sky-600 transition-all duration-300"
                      >
                        더보기
              ...
              <ScrollReveal key={step.num} delay={i * 80}>
                <div className="bg-white rounded-2xl overflow-hidden border border-gray-100 shadow-sm hover:shadow-xl transition-all duration-300 group">
                  ...
                  <div className="p-3 sm:p-5 text-center">
                    ...
                    <p className="text-gray-600 text-sm sm:text-lg md:text-xl leading-relaxed sm:leading-loose mt-3 sm:mt-4 whitespace-pre-line">
                      {step.desc}
                    </p>
                  </div>
                </div>
          ...
          <div className="grid grid-cols-2 lg:grid-cols-3 gap-3 sm:gap-5">
            {[
              ...
              <ScrollReveal key={item.num} delay={i * 100}>
                <div className="group bg-white/[0.06] backdrop-blur-md border border-white/[0.1] rounded-xl sm:rounded-2xl p-3 sm:p-7 text-center cursor-default transition-all duration-400 hover:-translate-y-2 hover:border-sky-400/50 hover:bg-white/[0.12] hover:shadow-[0_0_30px_rgba(56,189,248,0.15)]">
                  {/* Icon */}
                  <div className="text-sky-400 group-hover:text-gold-400 transition-colors duration-400 flex justify-center mb-2 sm:mb-5 [&>svg]:w-6 [&>svg]:h-6 sm:[&>svg]:w-10 sm:[&>svg]:h-10">
                    {item.icon}
                  </div>

                  {/* Number badge */}
                  <div className="w-6 h-6 sm:w-10 sm:h-10 rounded-full bg-sky-500 text-white font-bold text-xs sm:text-base flex items-center justify-center mx-auto mb-1 sm:mb-4">
                    {item.num}
                  </div>

                  {/* Title */}
                  <h3 className="text-white font-bold text-sm sm:text-xl mb-1 sm:mb-2">{item.title}</h3>

                  {/* Description */}
                  <p className="text-white/60 text-xs sm:text-lg leading-relaxed sm:leading-loose">{item.desc}</p>
                </div>
              </ScrollReveal>
            ))}
          </div>
      ...
      <section className="relative w-full overflow-hidden flex items-center" style={{ minHeight: "auto" }}>
        ...
        <div className="relative z-10 w-full py-12 md:py-24 px-4 sm:px-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-0 max-w-6xl mx-auto">
            {/* 좌측 - 초음파 장비 */}
            <ScrollReveal>
              <div className="text-center md:text-right md:pr-12 md:border-r border-white/20">
                <h3 className="text-lg sm:text-3xl font-bold text-white mb-3 sm:mb-5">
                  최상급 초음파 LOGIQ P9
                </h3>
                <ul className="space-y-2 sm:space-y-3">
                  {[
                    ...
                    <li
                      key={item}
                      className="flex items-start gap-2 text-white/80 text-sm sm:text-xl md:justify-end"
                    >
              ...
              <div className="text-center md:text-left md:pl-12">
                ...
                <ul className="space-y-2 sm:space-y-3">
                  {[
                    ...
                    <li
                      key={item}
                      className="flex items-start gap-2 text-white/80 text-sm sm:text-xl"
                    >
                      <span className="text-sky-400 font-bold shrink-0 mt-px">·</span>
                      {item}
                    </li>
          ...
          <div className="grid grid-cols-3 gap-3 sm:gap-8 text-center">
            <ScrollReveal>
              <div className="flex flex-col items-center">
                <div className="w-12 h-12 sm:w-16 sm:h-16 mb-3 sm:mb-4 flex items-center justify-center">
                  <svg className="w-10 h-10 sm:w-14 sm:h-14 text-navy-800" fill="none" stroke="currentColor" viewBox="0 0 24 24" strokeWidth={1.2}>
                    <path strokeLinecap="round" strokeLinejoin="round" d="M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z" />
                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 11l1.5 1.5L14 9" />
                  </svg>
                </div>
                <div className="w-10 h-px bg-navy-200 mb-3 sm:mb-4"></div>
                <h3 className="text-sm sm:text-2xl font-bold text-navy-900 mb-1">
                  내시경 세부전문의
                </h3>
                <p className="text-gray-400 text-xs sm:text-lg">숙련된 의료 서비스</p>
              </div>
            </ScrollReveal>
            ...
            <ScrollReveal delay={150}>
              <div className="flex flex-col items-center">
                ...
                <p className="text-gray-400 text-xs sm:text-lg">ONE-STOP 의료서비스</p>
              </div>
            </ScrollReveal>
